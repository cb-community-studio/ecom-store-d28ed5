...
const ProductCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div>
                <p className="m-0">ProductCode:</p>
                <InputText className="w-full mb-3" value={_entity?.productCode} onChange={(e) => setValByKey("productCode", e.target.value)}  />
            </div>
            <div>
            ...
            <div>
                ...
                <Checkbox checked={_entity?.stock} onChange={ (e) => setValByKey("stock", e.checked)}  ></Checkbox>
            </div>
